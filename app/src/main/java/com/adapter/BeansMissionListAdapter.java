...
public class BeansMissionListAdapter extends BaseAdapter {
	...
	public BeansMissionListAdapter(Context ctx){
		context = ctx;
	}
	@Override
	public int getCount() {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(mission!=null) {
			String is_task = null;
			try {
				is_task = data.getString("is_task");
			} catch (JSONException e) {
				e.printStackTrace();
			}
			Log.e("TAG", "getView: is_task = " + is_task );
